...
void main() => runApp(const Viewallidea());

class Viewallidea extends StatelessWidget {
  const Viewallidea({Key? key}) : super(key: key);

  static const String _title = 'View all Idea';
  ...
  Future<dynamic> viewIdea() async {
    ...
    var response = await http.post(Uri.parse('${Con.url}viewallidea.php'), body: data);
    print(response.body);
